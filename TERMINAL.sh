...
then
echo " Info"|lolcat
echo "SEKOLAH : STM 12 PLOEIT "|lolcat
sleep 0.1
echo "JAKARTA BARAT - GROGOL"|lolcat
sleep 0.1
echo "Tools ini di buat oleh MR.DarkSkull"|lolcat
sleep 0.2
echo "Ini No root ya gan"|lolcat
sleep 0.2
echo "follow ig mr.darkskull"|lolcat
sleep 0.2
echo "yang mau Kerjasama"|lolcat
sleep 0.2
echo "Email : dimasdos075@gmail.com"|lolcat
sleep 0.2
echo "Yang mau donasi Gopay/pulsa"|lolcat
sleep 0.2
echo "087876174671"|lolcat
fi
...
echo "recode mati :v"|lolcat
echo "Ni contak gw : 087888336682"|lolcat
